...
export default function FolderExplorer() {
  ...
  const fetchFolders = async () => {
    try {
      ...
      setFolders(Array.isArray(response.data) ? response.data : []); // ✅ Đảm bảo folders luôn là mảng
    } catch (error) {
      console.error("Error fetching folders:", error);
      setFolders([]); // ✅ Nếu lỗi, đặt folders là mảng rỗng
    }
  };
  ...
  return (
    <div className="p-5 bg-gray-100 min-h-screen z-50 text-black">
      <div className="max-w-3xl mx-auto bg-white p-5 rounded shadow">
        <h1 className="text-2xl font-bold mb-4">Google Drive Manager</h1>
          ...
          <div className="mt-4">
            ...
            <ul className="border p-2 rounded bg-gray-50">
              {files?.length > 0 ? (
                ...
                <li className="p-2 text-gray-500">No files found</li>
              )}
            </ul>
            <div className="mt-3">
